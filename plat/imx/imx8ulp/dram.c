...
static volatile bool sys_dvfs = false;
static int num_fsp;
...
void dram_lp_auto_enable(void)
{
	...
	if (dram_auto_lp_true) {
		...
		/*
		 * 12.c TBC! : Set DENALI_CTL_144 [LPI_CTRL_REQ_EN[24]] and [DFI_LP_VERSION[16]] back
